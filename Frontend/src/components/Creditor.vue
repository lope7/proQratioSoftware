...
export default {
  ...
  methods: {
    ...
    /**
     * @vuese
     * Method that outputs a list of all the creditors in the database by means of a
     * request to the API.
     */
    list() {
      let me = this;
      ...
      axios
        .get("person/creditorList", config)
    ...
    /**
     * @vuese
     * Method that saves creditors in the database or edits them through an API request.
     */
    save() {
      let me = this;
      let header = { Token: this.$store.state.token };
    ...
    /**
     * @vuese
     * Method that deactivates a creditor through an API query.
     */
    deactivate() {
      let me = this;
      let header = { Token: this.$store.state.token };
