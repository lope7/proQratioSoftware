...
export default {
  ...
  methods: {
    ...
    /**
     * @vuese
     * Method that outputs a list of all the clients in the database by means of a
     * request to the API.
     */
    list() {
      let me = this;
    ...
    validator() {
      ...
      if (this.email.length > 50) {
        this.validateMessage.push("Email must have less than 50 characters.");
      }
    ...
    /**
     * @vuese
     * Method that saves clients in the database or edits them through an API request.
     */
    save() {
      let me = this;
      let header = { Token: this.$store.state.token };
    ...
    /**
     * @vuese
     * Method that activates a client through an API query.
     */
    activate() {
      let me = this;
      let header = { Token: this.$store.state.token };
    ...
    /**
     * @vuese
     * Method that unsubscribe a client through an API query.
     */
    deactivate() {
      let me = this;
      let header = { Token: this.$store.state.token };
